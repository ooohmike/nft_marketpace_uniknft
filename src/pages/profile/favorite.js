...
const Fav = () => {
    ...
    const getFavs = async () => {
        ...
        query.containedIn('likers', [account]);
    ...
    const render_market_item = (props, index) => {
        return (
            <div className={view} onClick={() => { link2detail(props.contractAddress, props.nftId) }} key={index}>
                ...
                <div className="product-content">

                    {
                        market_items.map((market, index) => {
                            return (
                                render_market_item(market.attributes, index)
                            )
                        })
                    }
                </div>
